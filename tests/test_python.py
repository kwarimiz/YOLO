...
def test_youtube():
    ...
    # Handle internet connection errors and 'urllib.error.HTTPError: HTTP Error 429: Too Many s'
...
def test_hub():
    ...
    from ultralytics.hub.utils import smart_

    export_fmts_hub()
    logout()
    smart_("GET", "https://github.com", progress=True)
